...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        en: {
            ...
            'about-title': 'About',
            'about-desc': 'Video production centered on Blender and DaVinci Resolve,<br>including over 20 video works and 3D model productions through collaborations.<br>Started freelance work as video producer and 3D modeler in 2025.',
        ...
        ko: {
            ...
            'about-title': '소개',
            'about-desc': 'Blender와 DaVinci Resolve를 활용한 영상 제작을 중심으로,<br>공동 제작을 포함 20편 이상의 영상 작품과 3D 모델 제작을 진행했습니다.<br>2025년부터 프리랜서로 영상 제작 및 3D 모델러 업무를 시작했습니다.',
            'history-title': '경력',
            'year-2021': '2021년',
        ...
        ja: {
            ...
            'about-title': '自己紹介',
            'about-desc': 'BlenderやDaVinci Resolveを用いた映像制作を中心に、共同制作を含め20本以上の映像作品や、3Dモデル単体の制作を行っています。',
            'history-title': '経歴',
...
function openSkillsModal(skillType) {
    ...
    // スマホの場合はlanguage UIを非表示
    const languageUI = document.querySelector('.language-ui');
    if (window.innerWidth <= 768 && languageUI) {
        languageUI.style.display = 'none';
    }
...
function closeSkillsModal() {
    ...
    // スマホの場合はlanguage UIを再表示
    const languageUI = document.querySelector('.language-ui');
    if (window.innerWidth <= 768 && languageUI) {
        languageUI.style.display = 'flex';
    }
}
